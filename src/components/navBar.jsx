...
import { Presentation, Skills, Tools, Projects, Ideas } from "./component.js";

const NavBar = () => {
  return (
    <nav className="w-1/4 rounded-3xl shadow-left-bottom relative left-[28%] top-[15px] py-4 px-3 flex justify-center ">
      <ul className="flex space-x-2 p-0 mt-6">
        <li>
          <a
            href="<Presentation />"
        ...
        <li>
          ...
          >
            <svg
              ...
              fill="#323232"
            >
              <path d="M2 13.122a1 1 0 00.741.966l7 1.876A1 1 0 0011 14.998V14h2a1 1 0 001-1V3a1 1 0 00-1-1h-2v-.994A1 1 0 009.741.04l-7 1.876A1 1 0 002 2.882v10.24zM9 2.31v11.384l-5-1.34V3.65l5-1.34zM11 12V4h1v8h-1z"></path>
            </svg>
            <span className="mt-1 text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300">
              Projects & Ideas
            </span>
